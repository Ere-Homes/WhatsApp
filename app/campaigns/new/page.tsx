  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "28px 20px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 4 }}>
        <Link href="/campaigns" className="btn btn-ghost btn-sm" style={{ marginLeft: -10 }}>← Campaigns</Link>
        <Link href="/campaigns/history" style={{ fontSize: 13, color: "var(--blue)", fontWeight: 600, textDecoration: "none", whiteSpace: "nowrap" }}>Campaign log →</Link>
      </div>
      <h1 className="h1" style={{ margin: "0 0 6px" }}>Advanced campaign builder</h1>
      <p style={{ color: "var(--ink-2)", fontSize: 14, marginTop: 0, marginBottom: 20 }}>
        Send an approved template to many contacts at once — paste numbers or build a CRM segment, personalize variables, and drip safely. Blacklisted contacts are skipped automatically.
      </p>
