...
export const RECENT = [
  { name: "Aisha Rahman", msg: "Yes, Tuesday at 4pm works for the viewing.", time: "2m", unread: 2, tag: "Hot" },
  { name: "David Okonkwo", msg: "What's the service charge on the Creek unit?", time: "18m", unread: 1, tag: "Warm" },
  { name: "Priya Nair", msg: "Send me details", time: "41m", unread: 0, tag: "Hot" },
  { name: "Mohammed Al Suwaidi", msg: "Thanks, I'll review the floor plan tonight.", time: "1h", unread: 0, tag: "" },
  { name: "Elena Volkova", msg: "Прислать цены, пожалуйста.", time: "2h", unread: 0, tag: "Warm" },
];

export const TPL_PERF = [
  { name: "palm_jumeirah_offer_v3", sent: 412, reply: 38 },
  { name: "dch_new_launch", sent: 388, reply: 31 },
  { name: "welcome_intro_optin", sent: 256, reply: 64 },
  { name: "viewing_reminder", sent: 199, reply: 12 },
];

/* ── Campaigns ── */
export type Campaign = {
  name: string; template: string; segment: string; audience: number;
  sent: number; delivered: number; read: number; replied: number;
  status: "sent" | "sending" | "scheduled" | "draft"; date: string;
};

export const CAMPAIGNS: Campaign[] = [
  { name: "Palm Jumeirah signature offer", template: "palm_jumeirah_offer_v3", segment: "Palm Jumeirah owners", audience: 412, sent: 412, delivered: 401, read: 268, replied: 38, status: "sent", date: "28 May 2026" },
  { name: "Creek Harbour launch, first look", template: "dch_new_launch", segment: "DCH waitlist", audience: 388, sent: 388, delivered: 379, read: 241, replied: 31, status: "sent", date: "01 Jun 2026" },
  { name: "Q3 valuation drive (Arabic)", template: "valuation_offer_ar", segment: "Downtown · Arabic", audience: 540, sent: 196, delivered: 190, read: 88, replied: 9, status: "sending", date: "Today" },
  { name: "Ramadan greeting", template: "ramadan_greeting", segment: "All opted-in", audience: 4120, sent: 4120, delivered: 4002, read: 3110, replied: 0, status: "sent", date: "01 Mar 2026" },
  { name: "Dubai South off-plan (RU)", template: "off_plan_launch_ru", segment: "Dubai South · Russian", audience: 132, sent: 0, delivered: 0, read: 0, replied: 0, status: "scheduled", date: "10 Jun 2026" },
  { name: "Town Square price update", template: "price_drop_alert", segment: "Town Square owners", audience: 305, sent: 0, delivered: 0, read: 0, replied: 0, status: "draft", date: "—" },
];

export const CAMP_STATUS: Record<string, { label: string; fg: string; bg: string; bd: string; dot: string }> = {
  sent: { label: "Sent", fg: "#fff", bg: "var(--green-dot)", bd: "var(--green-dot)", dot: "rgba(255,255,255,.9)" },
  sending: { label: "Sending", fg: "#fff", bg: "var(--blue)", bd: "var(--blue)", dot: "rgba(255,255,255,.9)" },
  scheduled: { label: "Scheduled", fg: "#fff", bg: "var(--amber-dot)", bd: "var(--amber-dot)", dot: "rgba(255,255,255,.9)" },
  draft: { label: "Draft", fg: "#fff", bg: "var(--ink-3)", bd: "var(--ink-3)", dot: "rgba(255,255,255,.9)" },
};

export type Segment = { name: string; count: number; community: string };
export const SEGMENTS: Segment[] = [
  { name: "Palm Jumeirah owners", count: 412, community: "Palm Jumeirah" },
  { name: "Dubai Creek Harbour waitlist", count: 388, community: "Dubai Creek Harbour" },
  { name: "Downtown · Arabic speakers", count: 540, community: "Downtown" },
  { name: "Town Square owners", count: 305, community: "Town Square" },
  { name: "Dubai South · Russian", count: 132, community: "Dubai South" },
  { name: "All opted-in contacts", count: 4120, community: "All communities" },
];

/* ── Insights ── */
export const COMMUNITIES = [
  { name: "Palm Jumeirah", sent: 1240, reply: 11.2 },
  { name: "Dubai Creek Harbour", sent: 1080, reply: 9.4 },
  { name: "Downtown", sent: 760, reply: 8.1 },
  { name: "Town Square", sent: 540, reply: 6.7 },
  { name: "Dubai South", sent: 420, reply: 5.2 },
];

/* ── Billing ── */
export const USAGE = [
  { cat: "Marketing conversations", count: 3840, rate: 0.0384 },
  { cat: "Utility conversations", count: 2110, rate: 0.0146 },
  { cat: "Service conversations", count: 1290, rate: 0.0 },
  { cat: "Authentication", count: 0, rate: 0.0204 },
];

export const INVOICES = [
  { id: "INV-2026-005", date: "01 May 2026", amount: 186.4, status: "paid" },
  { id: "INV-2026-004", date: "01 Apr 2026", amount: 204.12, status: "paid" },
  { id: "INV-2026-003", date: "01 Mar 2026", amount: 312.88, status: "paid" },
  { id: "INV-2026-002", date: "01 Feb 2026", amount: 142.5, status: "paid" },
];
